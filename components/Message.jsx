                ...
                <div className='flex items-center gap-2 opacity-70'>
                    {
                        role === 'user' ? (
                            <>
                                <Image src={assets.copy_icon} alt='copy-text'
                                className='w-4 cursor-pointer'
                                />
                                  <Image src={assets.pencil_icon} alt='edit'
                            ...
                            <>
                                ...
                                className='w-4.5 cursor-pointer'
                                />
                                 <Image src={assets.regenerate_icon} alt='regenerate'
                                className='w-4 cursor-pointer'
                                />
                                 <Image src={assets.like_icon} alt='like'
                                className='w-4 cursor-pointer'
                                />
                                 <Image src={assets.dislike_icon} alt='dislike'
                                className='w-4 cursor-pointer'
                                />
                            </>
                        )
